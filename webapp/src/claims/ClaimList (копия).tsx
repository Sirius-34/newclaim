        ...
        <table className={css.table}>
          <thead>
            <tr className={css.headerCell}>
              <th className={css.cell} style={{ width: '15%' }}>Автор</th>
              <th className={css.cell} style={{ width: '10%' }}>Создано</th>
              <th className={css.cell} style={{ width: '10%' }}>Номер дела в суде</th>
              <th className={css.cell} style={{ width: '10%' }}>Номер внутренней служебной записки</th>
          ...
          <tbody>
            {claims?.map((claim, rowIndex) => (
              ...
              >
                ...
                <td className={css.cell}>{claim.numCourtCase ?? '—'}</td>
                <td className={css.cell}>{claim.regNumIntDoc ?? '—'}</td>
